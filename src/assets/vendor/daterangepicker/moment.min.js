...
!(function (a, b) {
  ...
  function g(a, b) {
    ...
    return (
      f(b, 'toString') && (a.toString = b.toString), f(b, 'valueOf') && (a.valueOf = b.valueOf), a
    )
  }
  function h(a, b, c, d) {
  ...
  function G(a, b) {
    if (null != b) {
      ...
      null != nd[a] &&
        (null != nd[a].parentLocale ? (nd[a] = nd[a].parentLocale) : null != nd[a] && delete nd[a])
    return nd[a]
  }
  function H(a) {
    var b
  ...
  function Xa(a) {
    return (
      this._isUTC && (this.utcOffset(0, a), (this._isUTC = !1), a && this.subtract(Ta(this), 'm')),
      this
    )
  }
  function Ya() {
  ...
  ;(Ke._calendar = Ee),
    ...
    E('en', {
      ...
      ordinal: function (a) {
        var b = a % 10,
          c =
            1 === r((a % 100) / 10) ? 'th' : 1 === b ? 'st' : 2 === b ? 'nd' : 3 === b ? 'rd' : 'th'
        return a + c
      },
    }),
