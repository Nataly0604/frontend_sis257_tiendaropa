  ...
  <div class="checkout-container">
    ...
    <div class="checkout-content">
      ...
      <div v-if="carritoStore.estaVacio" class="carrito-vacio">
        ...
        <router-link to="/" class="btn btn-primary"> Ir a comprar </router-link>
      </div>
                ...
                <div class="qr-payment">
                  ...
                  <div class="qr-details">
                    <p>
                      ...
                      {{ carritoStore.formatearPrecio(carritoStore.totalCarrito) }}
                    </p>
...
const cambio = computed(() => {
  return montoPagado.value > carritoStore.totalCarrito
...
async function procesarPago() {
  ...
  try {
    ...
    const ventaData = {
      ...
      montoPagado:
        metodoPagoSeleccionado.value === 'efectivo' ? montoPagado.value : carritoStore.totalCarrito,
